...
var slideIndex = 1;
var objects = ["./images/yogurt1.png","./images/yogurt2.png","./images/yogurt3.png"];
var texts = ["./images/page2__yogurt-text-1.png","./images/page2__yogurt-text-2.png","./images/page2__yogurt-text-3.png"];
var zzz = [["./images/object2.png", "./images/object1.png"],["./images/object6.png","./images/object5.png"],["./images/object4.png", "./images/object3.png"]];
...
function setImages(variant) {
    ...
    var ingridients = document.querySelectorAll('.screen-4 .screen__ingrideent img');
    ...
    ingridients.forEach((el,index) => {
        el.setAttribute('src', zzz[variant][index]);
    })
}

function setObject() {
     var selectedObject = document.querySelector('.screen__object-container.active');
